...
async function aiPickSongs(city: string, mood?: string): Promise<AiTrack[] | null> {
  try {
...
export const spotifyService = {
  async getPlaylist(city: string, mood?: string): Promise<ToolResult<PlaylistSuggestion>> {
    const TRACK_COUNT = 5;
