...
const VIBE_POOLS: Record<string, { tracks: Track[]; names: string[]; descriptions: string[] }> = {
  chill: {
    ...
    tracks: [
      ...
      track('Stolen Dance', 'Milky Chance'),
      track('Put Your Records On', 'Corinne Bailey Rae'),
      track('Gravity', 'John Mayer'),
      track('Slow Dancing in a Burning Room', 'John Mayer'),
  ...
  contemplative: {
    ...
    tracks: [
      ...
      track('Hide and Seek', 'Imogen Heap'),
      ...
      track('River Flows in You', 'Yiruma'),
