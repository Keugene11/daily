...
function interestToVibes(interests) {
    const vibes = [];
    for (const interest of interests) {
        const i = interest.toLowerCase();
        if (i === 'outdoors')
            vibes.push('adventure', 'upbeat');
        else if (i === 'food')
            vibes.push('groovy', 'chill');
        else if (i === 'culture')
            vibes.push('contemplative', 'indie');
        else if (i === 'nightlife')
            vibes.push('nightout', 'groovy');
        else if (i === 'music')
            vibes.push('indie', 'groovy');
        else if (i === 'sports')
            vibes.push('upbeat', 'adventure');
        else if (i === 'shopping')
            vibes.push('upbeat', 'indie');
        else if (i === 'relaxation')
            vibes.push('chill', 'tropical');
        else if (i === 'tech' || i === 'coding')
            vibes.push('contemplative', 'nightout');
    }
    return vibes;
}
// ── City alias matching ─────────────────────────────────────────────────
...
exports.spotifyService = {
    async getPlaylist(city, interests, mood) {
        const TRACK_COUNT = 5;
